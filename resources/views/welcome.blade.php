...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h4>Los sistemas Multimedia en la Educacion</h4>
                    <p>El rápido desarrollo de la tecnología y de la informática está proporcionando herramientas
                        revolucionarias en todos los campos de la ciencia . En este sentido, los sistemas interactivos
                        multimedia se están integrando en nuestro entorno .
                    ...
                    <h4>Introduccion al Curso de Matematicas</h4>
                ...
                <div class="col-6">
                    <img src="/storage/imagenes/FondoW.jpg" width="500" height="400">
                </div>
            </div>
        </div>
    </div>
